...
import { GiViolin, GiHamburgerMenu } from "react-icons/gi";
        ...
        <div className="w-full fixed ml-1 top-0">
          <nav className="bg-teal-300 shadow-lg md:flex md:items-center md:justify-between p-2 rounded-lg mr-3 md:mr-6">
            <div>
              ...
              {toggle && <div className="text-base font-bold text-sky-700 hover:bg-sky-100">About Me</div>}
              {toggle && <div className="text-base font-bold text-sky-700 hover:bg-sky-100">Work Experience</div>}
              {toggle && <div className="text-base font-bold text-sky-700 hover:bg-sky-100">Education</div>}
              {toggle && <div className="text-base font-bold text-sky-700 hover:bg-sky-100">Hobbies</div>}
              {toggle && <div className="text-base font-bold text-sky-700 hover:bg-sky-100">Contact</div>}
            </div>
            <div>
