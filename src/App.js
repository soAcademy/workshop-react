...
const App = () => {
  return (
    <>
      ...
      <h1 className="text-lg">ตัวหนังสือ lg</h1>
...
// const App = () => {
//   return <h1 className="text-3xl-700">Hello, Bond</h1>
// };
// export default App;

// 2.เหมือนจะผิด จงสร้าง div ต่อไปนี้ มีเรื่อง W-H ด้วย
...
//       <div claassName="w-1/2 h-38 bg-yellow-300 rounded-lg">w-1/2</div>
//     </>
//   )
// };
// export default App;
